...
> _"Hospodaření státního rozpočtu skončilo v roce 2024 deficitem ve výši
...
- Odečte se _EU/FM revenue_ (transfery z EU rozpočtu + finančních mechanismů)
- Odečte se _EU/FM expenditure_ (refundovatelná část výdajů na společné projekty)

**Citace z SZÚ 2024 Sešit C:**

> _"Dopady příjmů z EU a FM a výdajů předfinancovaných na tyto společné projekty
> byl kladný ve výši 17,5 mld. Kč... bez těchto prostředků, které jsou ve schváleném
> rozpočtu zahrnuty s neutrálním dopadem, by schodek činil 288,9 mld. Kč."_
...
| 10  | Eurostat ESA 2010 notifikace          | `csu.gov.cz/notifikace-vladniho-deficitu-a-dluhu`                         | Pololetně, accrual basis, vládní sektor (S.13)           | Doplněk — _jiný scope než SR_                    |
...
Pravděpodobně specifika _post-covid účtování_ — vyhláška 412/2021 Sb. začala
...
v IISSP, a _EU portion vs national portion_ je rozlišena samostatným atributem,
