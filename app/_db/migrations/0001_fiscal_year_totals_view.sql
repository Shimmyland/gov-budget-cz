-- Materialized view: per-year totals of revenue, expenditure and balance (SR scope).
-- Refresh after every ETL import via:
--   REFRESH MATERIALIZED VIEW fiscal_year_totals;
--
-- SR scope: funding_source_code IN ('1','4','5') OR IS NULL (pre-2024 data lacks the column).
-- balance = revenue − expenditure; positive = přebytek, negative = schodek.
